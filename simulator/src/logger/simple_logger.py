...
class SimpleLogger(ILogger):
    ...
    def _filter_blacklisted_severities(self, lines: List[str]) -> List[str]:
    ...
    def flush(self, force: bool = False) -> bool:
        ...
        filtered_buffer = self._filter_blacklisted_severities(self._buffer)
