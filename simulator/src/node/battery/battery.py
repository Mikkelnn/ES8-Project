...
class Battery(IModule):
    ...
    def tick(self, current_consumption_joule) -> float:
        ...
        return 0 # The interface specifies consumption, and since battery is not consuming power but rather providing it, we return 0 here.
