        ...
        match self.state:
            ...
            case State.PACKET_FORWARDING:
                if len(self.d2d_packet_buffer) == 0:
                    ...
                    self.d2d_packet_buffer.append(LoRaD2DFrame(
                ...
                if self.current_slot == self.gw_hopcount % self.slot_count: # tx slot
                    ...
                    if ((current_local_clock_info.timer_2_remaining is None or current_local_clock_info.timer_2_remaining == 0)
                        and current_transceiver_states[medium] != TransceiverState.TRANSMITTING
                        and len(tx_buffer) > 0):
