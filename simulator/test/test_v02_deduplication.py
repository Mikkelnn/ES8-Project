...
def v02_instance(mock_dependencies):
    ...
    v02 = V02(
        node_id=1,
        local_event_queue=mock_dependencies['local_event_queue'],
        second_to_global_tick=0.001,
        log=mock_dependencies['log']
    )
    return v02
...
class TestD2DFrameDeduplication:
    ...
    def test_no_duplicates_all_frames_kept(self, v02_instance):
        ...
        frame2 = LoRaD2DFrame(
            ...
            type=LoRaD2DFrameType.DATA_TO_GW,
            payload=PayloadHopCntFull(cnt=2, slot_period_counter=0, use_slot=0, time_offset_from_period_start=0)
        )
        frame2.crc_calc()
        ...
        frame3 = LoRaD2DFrame(
            ...
            type=LoRaD2DFrameType.DATA_TO_GW,
            payload=PayloadHopCntFull(cnt=3, slot_period_counter=0, use_slot=0, time_offset_from_period_start=0)
        )
        frame3.crc_calc()
    ...
    def test_duplicate_d2d_rx_removed(self, v02_instance):
        ...
        frame = LoRaD2DFrame(
            ...
            destination_node_id={2},
            type=LoRaD2DFrameType.DATA_TO_GW,
            payload=PayloadHopCntFull(cnt=5, slot_period_counter=0, use_slot=0, time_offset_from_period_start=0)
        )
        frame.crc_calc()

        duplicate = LoRaD2DFrame(
            source_node_id=1,
            destination_node_id={2},
            type=LoRaD2DFrameType.DATA_TO_GW,
            payload=PayloadHopCntFull(cnt=5, slot_period_counter=0, use_slot=0, time_offset_from_period_start=0)
    ...
    def test_duplicate_across_rx_tx_keeps_tx_removes_rx(self, v02_instance):
        ...
        frame = LoRaD2DFrame(
            ...
            destination_node_id={2},
            type=LoRaD2DFrameType.DATA_TO_GW,
            payload=PayloadHopCntFull(cnt=10, slot_period_counter=0, use_slot=0, time_offset_from_period_start=0)
        )
        frame.crc_calc()
    ...
    def test_first_occurrence_kept_second_removed(self, v02_instance):
        ...
        frame1 = LoRaD2DFrame(
            ...
            destination_node_id={2},
            type=LoRaD2DFrameType.DATA_TO_GW,
            payload=PayloadHopCntFull(cnt=7, slot_period_counter=0, use_slot=0, time_offset_from_period_start=0)
        )
        frame1.crc_calc()
...
class TestCRCCalculationConsistency:
    ...
    def test_identical_frames_have_same_crc(self):
        ...
        frame1 = LoRaD2DFrame(
            source_node_id=5,
            destination_node_id={10, 20},
            type=LoRaD2DFrameType.CHANGE_HOP_COUNT,
            payload=PayloadHopCntFull(cnt=99, slot_period_counter=5, use_slot=1, time_offset_from_period_start=100)
        )
        frame1.crc_calc()
